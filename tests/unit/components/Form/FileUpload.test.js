...
import FileUpload from '@/packages/draftComponents/Form/FileUpload';
...
describe('components/Form/FileUpload', () => {
  ...
  describe('lifecycle hooks', () => {
    describe('mounted', () => {
      ...
      it.skip('should call .verifyFile() if fileName exists', () => {
        createTestSubject(FileUpload, {
          propsData: {
            ...mockLocalProps,
            value: 'mock_value',
      ...
      it.skip('should reset fileName if .verifyFile failed', async () => {
    ...
    describe('upload()', () => {
      ...
      describe('with file', () => {
        ...
        describe('put() returned a valid response', () => {
          ...
          it.skip('sets `fileName` to one generated by generateFileName()', async () => {
