import { createTestSubject } from '@/../tests/testHelpers';
import TimeInput from '@/packages/draftComponents/Form/TimeInput';
...
describe('components/TimeInput', () => {
  ...
  describe('`v-model` interface', () => {
    describe('when the `value` property changes', () => {
      ...
      describe('given the new `value` is different from the current `date`', () => {
        it.skip('sets `date` to equal the new `value`', () => {
      ...
      describe('given the new `value` is the same as the current `date`', () => {
        it.skip('avoids an infinite feedback loop by doing nothing (does not set `date`)', () => {
    ...
    describe.skip('when the internal `date` Date object changes', () => {
  ...
  describe.skip('#created lifecycle hook', () => {
  ...
  describe('properties', () => {
    wrapper = createTestSubject(TimeInput, {
      ...
      describe('legend attribute', () => {
        it.skip('is set when label is passed', () => {
