...
import Checkboxitem from '@/packages/draftComponents/Form/Checkboxitem';
...
describe('components/Form/Checkboxitem', () => {
  ...
  it('throws an error if the parent component is not "CheckboxGroup"', () => {
    ...
    // Attempt to mount CheckboxItem directly, which should fail
    const mountBadParent = () => {
    ...
    expect(mountBadParent).toThrow('CheckboxItem component can only be used inside a CheckboxGroup component');
