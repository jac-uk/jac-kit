...
import DateInput from '@/packages/draftComponents/Form/DateInput.vue';
...
describe('components/DateInput', () => {
  ...
  describe('computed properties', () => {
    ...
    describe('dateConstructor', () => {
      describe.skip('and `day`, `month` and `year` fields are set', () => {
      ...
      describe.skip('given property type="month"', () => {
        beforeEach(() => {
    ...
    describe('date', () => {
      describe('getter', () => {
          ...
          describe('given a date is set (`dateConstructor` returns constructor args)', () => {
            ...
            it.skip('is created as a UTC Date', () => {
