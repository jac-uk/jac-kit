...
describe('components/Form/RadioGroup', () => {
  ...
  describe('template', () => {
    it.skip('the root element has the `id` attribute which was passed in as prop `id`', () => {
      expect(wrapper.tagName).toBe('#example');
    });

    describe('<legend> element', () => {
      describe('when the `label` prop is set', () => {
        it.skip('displays the label in a <legend> element', () => {
      ...
      it.skip('is wrapped in a <fieldset>', () => {
    ...
    describe('`.govuk-radios` slot container', () => {
      ...
      it.skip('renders default slot content', () => {
        expect(slotContainer.text()).toBe('RadioItem components');
      });

      it.skip('is inside the <fieldset>', () => {
        const fieldset = wrapper.find('fieldset');
