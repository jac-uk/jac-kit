...
import RepeatableFields from '@/packages/draftComponents/RepeatableFields';
...
// import SelectionExerciseOfficer from '@/packages/draftComponents/RepeatableFields/SelectionExerciseOfficer';
  ...
  describe('template', () => {
    ...
    describe('Remove button slot', () => {
      describe('when there are more then one repeatable field', () => {
        it.skip('render a button for every repeatable field', () => {
          wrapper = createTestSubject(
      ...
      describe('when there is only one field', () => {
        ...
        it.skip('renders if allowEmpty=true', () => {
          wrapper = createTestSubject(
            { value: [{ name: 'first' }],
              component: TextField,
              allowEmpty: true,
