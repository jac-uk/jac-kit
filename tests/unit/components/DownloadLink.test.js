...
import DownloadLink from '@/packages/draftComponents/DownloadLink';
...
describe('components/DownloadLink', () => {
  ...
  describe('lifecycle hooks', () => {
    describe('mounted', () => {
      ...
      it.skip('should call .getDownloadURL()', () => {
      ...
      it.skip('should set linkHref if .getDownloadURL() returned download url', async () => {
        expect.assertions(1);
