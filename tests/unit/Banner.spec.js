...
xdescribe('components/Banner/Banner', () => {
  xdescribe('props', () => {
    let prop;
    describe('message', () => {
      beforeEach(() => {
  ...
  describe('component instance', () => {
    describe('when status = success', () => {
      const wrapper = createTestSubject(Banner, {
        propsData: {
          message: 'mockMessage',
          status: 'success',
        },
      ...
      xdescribe('template', () => {
            ...
            it('class', () => {
              expect(
                wrapper
                  ...
                  .at(0)
                  .attributes('class')
              ).toBe('moj-banner moj-banner--success');
            });
          });
        ...
        describe('svg attributes', () => {
          ...
          it('xmlns', () => {
            expect(wrapper.find('svg').attributes('xmlns')).toBe(
        ...
        describe('path', () => {
          it('d attribute', () => {
            expect(wrapper.find('svg > path').attributes('d')).toBe(
              'M25,6.2L8.7,23.2L0,14.1l4-4.2l4.7,4.9L21,2L25,6.2z'
            );
          });
        });
        describe('span', () => {
          it('class', () => {
            expect(wrapper.find('div > span').attributes('class')).toBe(
    ...
    xdescribe('when status is empty', () => {
      ...
      describe('template', () => {
        ...
        describe('path', () => {
          it('d attribute', () => {
            expect(wrapper.find('svg > path').attributes('d')).toBe(
              'M13.7,18.5h-2.4v-2.4h2.4V18.5z M12.5,13.7c-0.7,0-1.2-0.5-1.2-1.2V7.7c0-0.7,0.5-1.2,1.2-1.2s1.2,0.5,1.2,1.2v4.8 C13.7,13.2,13.2,13.7,12.5,13.7z M12.5,0.5c-6.6,0-12,5.4-12,12s5.4,12,12,12s12-5.4,12-12S19.1,0.5,12.5,0.5z'
            );
          });
        });
