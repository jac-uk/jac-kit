...
Primarily the JAC Kit is for our own benefit (code sharing, [component-driven development](https://www.componentdriven.org/)). That said we develop in the open and - you never know - there might be something useful to the wider community.
